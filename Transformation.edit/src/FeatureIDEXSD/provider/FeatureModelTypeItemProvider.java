...
/**
 * This is the item provider adapter for a {@link FeatureIDEXSD.FeatureModelType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FeatureModelTypeItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FeatureIDEXSDPackage.Literals.FEATURE_MODEL_TYPE__PROPERTIES);
			childrenFeatures.add(FeatureIDEXSDPackage.Literals.FEATURE_MODEL_TYPE__STRUCT);
			childrenFeatures.add(FeatureIDEXSDPackage.Literals.FEATURE_MODEL_TYPE__CONSTRAINTS);
			childrenFeatures.add(FeatureIDEXSDPackage.Literals.FEATURE_MODEL_TYPE__CALCULATIONS);
			childrenFeatures.add(FeatureIDEXSDPackage.Literals.FEATURE_MODEL_TYPE__COMMENTS);
			childrenFeatures.add(FeatureIDEXSDPackage.Literals.FEATURE_MODEL_TYPE__FEATURE_ORDER);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FeatureIDEXSDPackage.Literals.FEATURE_MODEL_TYPE__PROPERTIES,
				 FeatureIDEXSDFactory.eINSTANCE.createPropertiesType()));

		newChildDescriptors.add
			(createChildParameter
				(FeatureIDEXSDPackage.Literals.FEATURE_MODEL_TYPE__STRUCT,
				 FeatureIDEXSDFactory.eINSTANCE.createStructType()));

		newChildDescriptors.add
			(createChildParameter
				(FeatureIDEXSDPackage.Literals.FEATURE_MODEL_TYPE__CONSTRAINTS,
				 FeatureIDEXSDFactory.eINSTANCE.createConstraintsType()));

		newChildDescriptors.add
			(createChildParameter
				(FeatureIDEXSDPackage.Literals.FEATURE_MODEL_TYPE__CALCULATIONS,
				 FeatureIDEXSDFactory.eINSTANCE.createCalculationsType()));

		newChildDescriptors.add
			(createChildParameter
				(FeatureIDEXSDPackage.Literals.FEATURE_MODEL_TYPE__COMMENTS,
				 FeatureIDEXSDFactory.eINSTANCE.createCommentsType()));

		newChildDescriptors.add
			(createChildParameter
				(FeatureIDEXSDPackage.Literals.FEATURE_MODEL_TYPE__FEATURE_ORDER,
