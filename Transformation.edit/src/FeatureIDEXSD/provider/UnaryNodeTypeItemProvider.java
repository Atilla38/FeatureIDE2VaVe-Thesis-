...
/**
 * This is the item provider adapter for a {@link FeatureIDEXSD.UnaryNodeType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UnaryNodeTypeItemProvider extends NodeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public UnaryNodeTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FeatureIDEXSDPackage.Literals.UNARY_NODE_TYPE__NODE_GROUP);
		}
	...
	/**
	 * This returns UnaryNodeType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/UnaryNodeType"));
	}
	...
	public String getText(Object object) {
		String label = ((UnaryNodeType)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_UnaryNodeType_type") :
			getString("_UI_UnaryNodeType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UnaryNodeType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FeatureIDEXSDPackage.Literals.UNARY_NODE_TYPE__NODE_GROUP,
				 FeatureMapUtil.createEntry
					(FeatureIDEXSDPackage.Literals.UNARY_NODE_TYPE__NODE_LIST,
