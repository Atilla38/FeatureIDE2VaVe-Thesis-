...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Unary Extended Node Type</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link FeatureIDEXSD.UnaryExtendedNodeType#getExtendedNodeGroup <em>Extended Node Group</em>}</li>
 *   <li>{@link FeatureIDEXSD.UnaryExtendedNodeType#getFeature <em>Feature</em>}</li>
 *   <li>{@link FeatureIDEXSD.UnaryExtendedNodeType#getAlt <em>Alt</em>}</li>
 *   <li>{@link FeatureIDEXSD.UnaryExtendedNodeType#getOr <em>Or</em>}</li>
 *   <li>{@link FeatureIDEXSD.UnaryExtendedNodeType#getAnd <em>And</em>}</li>
 * </ul>
 *
 * @see FeatureIDEXSD.FeatureIDEXSDPackage#getUnaryExtendedNodeType()
 * @model extendedMetaData="name='unaryExtendedNodeType' kind='elementOnly'"
 * @generated
 */
public interface UnaryExtendedNodeType extends ExtendedNode {
	/**
	 ...
	 * @see FeatureIDEXSD.FeatureIDEXSDPackage#getUnaryExtendedNodeType_ExtendedNodeGroup()
	 ...
	 * @see FeatureIDEXSD.FeatureIDEXSDPackage#getUnaryExtendedNodeType_Feature()
	 ...
	 * @see FeatureIDEXSD.FeatureIDEXSDPackage#getUnaryExtendedNodeType_Alt()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see FeatureIDEXSD.FeatureIDEXSDPackage#getUnaryExtendedNodeType_Or()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see FeatureIDEXSD.FeatureIDEXSDPackage#getUnaryExtendedNodeType_And()
	 * @model containment="true" transient="true" volatile="true" derived="true"
